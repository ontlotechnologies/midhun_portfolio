      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-4 text-left flex flex-col justify-center">
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#353a5f] font-bold block mb-2">
              THE JOURNEY
            </span>
            ...
            <svg className="w-16 h-3 text-[#353a5f]/60 mb-6" viewBox="0 0 100 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div>
              <button
                ...
                className="px-6 py-2.5 bg-[#353a5f] hover:bg-gold-500 text-white hover:text-charcoal-900 font-semibold text-[10px] uppercase tracking-widest rounded-lg transition-all duration-300 shadow-sm cursor-pointer inline-flex items-center gap-2 group"
              >
          ...
          <div className="lg:col-span-8 relative mt-6 lg:mt-0">
            <div className="relative w-full">
              ...
              <div className="hidden lg:block absolute left-8 right-8 h-[1px] border-t border-dashed border-[#353a5f]/25 bottom-[14px] z-0" />
                ...
                {events.map((event, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bg-white border border-cream-300 rounded overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.02)] group-hover:border-gold-500/20 group-hover:shadow-[0_8px_30px_rgba(0,0,0,0.05)] transition-all duration-500 flex-1 flex flex-col w-full">
                        ...
                        <div className="p-4 flex-1 flex flex-col justify-start text-left">
                          <span className="font-sans text-[11px] font-bold text-[#353a5f] tracking-wider block mb-1">
                            {event.year}
                          </span>
                          <h3 className="font-sans text-charcoal-900 font-bold text-xs md:text-[13px] leading-snug mb-1.5 group-hover:text-[#353a5f] transition-colors duration-300">
                            {event.title}
                          </h3>
                      ...
                      <div className="hidden lg:block h-6 w-[1px] border-l border-dashed border-[#353a5f]/25 relative z-10 mt-3"></div>

                      {/* Circle node dot (visible on desktop lg) */}
                      <div className="hidden lg:flex w-2.5 h-2.5 rounded-full border border-[#353a5f] bg-white items-center justify-center relative z-20 group-hover:bg-[#353a5f] transition-colors duration-300 shadow-[0_0_6px_rgba(53,58,95,0.15)]">
                        <div className="w-1 h-1 bg-[#353a5f] rounded-full group-hover:bg-white transition-colors duration-300" />
                      </div>
